...
if (b.house > a.house) {
    ...
    return parseFloat(a.children.length) - parseFloat(b.children.length);
    }
...
a regular expression pattern to return true if the input contains a number, and false if the input does not 
contain a number.
