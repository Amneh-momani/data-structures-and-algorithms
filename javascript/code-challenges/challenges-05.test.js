...
return people.reduce( (accumulator, person) => {
  ...
  return [...accumulator, person.firstName+" "+person.lastName]
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce((sum, li) => sum + li.purchasePrice, 0); 
...
Write a function named countNumberOfElements that, given an array as input, uses reduce to 
